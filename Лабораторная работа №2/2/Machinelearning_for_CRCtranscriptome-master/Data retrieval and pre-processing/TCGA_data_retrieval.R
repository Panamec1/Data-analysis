...
# download the transcriptome profile of CRC (both COAD and READ projects)  choose FPKM values
...
# data processing: combine tumor samples and normal samples; take out clinicl information and genetic information
...
#store clincal and genetic information seperately 
rownames(data[2,])
class(data)
...
# download the transcriptome profile of CRC (both COAD and READ projects)  choose raw counts
